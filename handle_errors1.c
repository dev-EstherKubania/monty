...
/**
 * process_usage_err - Prints an error message for incorrect command line usage
 *
 */
...
/**
 * process_f_open_err - Prints an error message for file opening failure
...
/**
 * process_invalid_op_err - Prints an error message for unknown opcode
...
/**
 * process_push_err - Prints an error message for invalid push arguments
 * @line_num: Line number where the error occurred
 *
 */
